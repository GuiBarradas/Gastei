...
All data below is synthetic, generated by `scripts/seed_demo_data.py` — real data never leaves your machine.

![Dashboard — per-bank balances, period KPIs, spending by category and monthly trend](docs/screenshots/dashboard.png)

| Transactions — dropdown recategorization feeds the LLM few-shots | Chat — tool-use agent over your own data |
|---|---|
| ![Transactions view](docs/screenshots/transacoes.png) | ![Chat view](docs/screenshots/chat.png) |
